...
Product, order, exchange, and payment scenarios tested

6. Database Interaction & Transactions (Phase VI)
Stored Procedures
...
7. Advanced Programming & Auditing (Phase VII)
Business Rule
...
All attempts are logged with ALLOWED / DENIED status.

Implementation

PUBLIC_HOLIDAY table

IS_RESTRICTED_DAY function

Audit logging procedure

Compound trigger on ORDERS and PAYMENTS
...
8. Business Intelligence & Documentation (Phase VIII)
BI KPIs

Total revenue

Exchange vs purchase ratio
